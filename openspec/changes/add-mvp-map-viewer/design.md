...
- **世界観**: 2テーマで明確に差別化する。シンプルテーマは白基調のクリーンなライトUI、レトロゲームテーマは8-bit/16-bit世代のゲームメニュー画面を想起させる硬い境界線・ドット感のあるダークUI
...
- **配色パレット(70/25/5ルール準拠、shared-rules/ui-design/styling-rule/color.md基準)**
  ...
  レトロゲームテーマ(視覚優先・アクセシビリティ非保証):
  - base 70%: `#0B0B12`(漆黒に近いネイビー)
  - main 25%: `#241E3D`(深紫)
  - accent 5%: `#FF3D81`(ネオンピンク)
  - accentにグロー(box-shadowでの発光表現)を効かせ、シンプルテーマとの視覚差を明確にする
